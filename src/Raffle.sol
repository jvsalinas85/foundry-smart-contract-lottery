...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    uint256 private immutable i_interval; // @dev The interval at which the raffle will automatically pick a winner in seconds
    ...
    constructor(
        uint256 entranceFee,
        // @dev The time interval in seconds for picking a winner
        uint256 interval,
